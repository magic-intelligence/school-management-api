...
export class CrearEstructuraEntities1740290691495 implements MigrationInterface {
    name = 'CrearEstructuraEntities1740290691495'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "student_family" ADD CONSTRAINT "FK_63ef95c225243898ad146665802" FOREIGN KEY ("familier_id") REFERENCES "parent_family"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
